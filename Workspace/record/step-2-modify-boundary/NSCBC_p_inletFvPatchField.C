...
#include "NSCBC_p_inletFvPatchField.H"
...
template<class Type>
Foam::NSCBC_p_inletFvPatchField<Type>::NSCBC_p_inletFvPatchField
(
    const fvPatch& p,
...
Foam::NSCBC_p_inletFvPatchField<Type>::NSCBC_p_inletFvPatchField
(
    const NSCBC_p_inletFvPatchField& ptf,
    const fvPatch& p,
    const DimensionedField<Type, volMesh>& iF,
...
Foam::NSCBC_p_inletFvPatchField<Type>::NSCBC_p_inletFvPatchField
(
    const NSCBC_p_inletFvPatchField& ptpsf
)
:
...
Foam::NSCBC_p_inletFvPatchField<Type>::advectionSpeed() const
{
...
template<class Type>
Foam::tmp<Foam::scalarField>
Foam::NSCBC_p_inletFvPatchField<Type>::soundSpeed() const
{
...
template<class Type>
void Foam::NSCBC_p_inletFvPatchField<Type>::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
template<class Type>
void Foam::NSCBC_p_inletFvPatchField<Type>::write(Ostream& os) const
{
