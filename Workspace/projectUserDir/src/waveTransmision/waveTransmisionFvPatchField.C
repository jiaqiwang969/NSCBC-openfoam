...
#include "waveTransmisionFvPatchField.H"
...
template<class Type>
Foam::waveTransmisionFvPatchField<Type>::waveTransmisionFvPatchField
(
    const fvPatch& p,
...
Foam::waveTransmisionFvPatchField<Type>::waveTransmisionFvPatchField
(
    const waveTransmisionFvPatchField& ptf,
    const fvPatch& p,
    const DimensionedField<Type, volMesh>& iF,
...
Foam::waveTransmisionFvPatchField<Type>::waveTransmisionFvPatchField
(
    const waveTransmisionFvPatchField& ptpsf
)
:
...
Foam::waveTransmisionFvPatchField<Type>::advectionSpeed() const
{
...
template<class Type>
void Foam::waveTransmisionFvPatchField<Type>::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
template<class Type>
void Foam::waveTransmisionFvPatchField<Type>::write(Ostream& os) const
{
