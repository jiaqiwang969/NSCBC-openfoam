...
alpha_til = tort + inv(1j*omega*q_0)*nu*phi* sqrtm(eye(3) + (1i*omega/nu)*(2*tort*q_0/(phi*LCV))^2);
% alpha_til = alpha + inv(1j*omega*q_0)*nu*phi* sqrt(eye(3) + (1i*omega/nu*(phi*LCV))^2)*(2*alpha*q_0)
