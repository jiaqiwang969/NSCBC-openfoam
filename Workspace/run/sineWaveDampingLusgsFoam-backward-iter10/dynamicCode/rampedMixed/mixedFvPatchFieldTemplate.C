...
// dynamicCode:
// SHA1 = e1756903c02300c50252514c02942d466b1efe82
//
// unique function name that can be checked if the correct library version
// has been loaded
extern "C" void rampedMixed_e1756903c02300c50252514c02942d466b1efe82(bool load)
{
    if (load)
    {
...
//{{{ begin code
    #line 35 "/lustre/home/acct-medgm/medgm/05-NSCBC/Workspace/run/sineWaveDampingLusgsFoam/0/U.boundaryField.inlet"
const scalar t = this->db().time().value();
	    ...
	    this->refValue() =
		scale_*amplitude_*sin(2*pi*frequency_*t)*exp(-sqr(t-0.0028)/0.0000018) + level_;
	    this->refGrad() = Zero;
