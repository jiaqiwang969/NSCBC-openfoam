...
// dynamicCode:
// SHA1 = 55cbe97ae35bead86fa6dc7d28563db0b424580d
//
// unique function name that can be checked if the correct library version
// has been loaded
extern "C" void rampedMixed_55cbe97ae35bead86fa6dc7d28563db0b424580d(bool load)
{
    if (load)
    {
...
const scalar t = this->db().time().value();
	    ...
	    this->refValue() =
		amplitude_*exp(-sqr(t-0.0028)/0.0000018) + level_;
	    this->refGrad() = Zero;
