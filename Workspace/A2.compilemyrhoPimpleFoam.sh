...
echo "Compiling myrhoPimpleFoam"
#srun -n 1 -N 1 
...
singularity exec -B $projectUserDir:/home/ofuser/OpenFOAM/ofuser-$theVersion $theImage myrhoPimpleFoam -help | tee $logsDir/myrhoPimpleFoam.$SLURM_JOBID
